...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__TaskList__ = __webpack_require__(29);
...
const TaskList = ({ tasks }) => {
  return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
    'ul',
    null,
    tasks.map(task => __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
      'li',
      { key: task.id },
      task.description
    ))
